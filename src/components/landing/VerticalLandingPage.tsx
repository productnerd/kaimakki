      ...
      <section className="mt-16">
        ...
        <div className="max-w-2xl mx-auto">
          {[
            ...
            { step: "4", icon: "📦", title: "Your strategy pack", desc: "After the session, you get your video branding guidelines (visual style, colours, animation, pacing, music direction), a content calendar, and all the video ideas — ready to go.", tag: "First order" },
            { step: "5", icon: "🎬", title: "Film your footage", desc: "We send you a shot list for each video. You film on your phone. No fancy gear needed.", tag: null },
            { step: "6", icon: "📤", title: "Send us the footage", desc: "Upload your clips. We take it from here.", tag: null },
            { step: "7", icon: "✂️", title: "We edit", desc: "Our editors turn your footage into scroll-stoppers using your branding guidelines.", tag: null },
            { step: "8", icon: "🔄", title: "Review + 1 free revision", desc: "Watch your video. Don't love something? Give feedback and we'll revise it once — on us.", tag: null },
            { step: "9", icon: "🚀", title: "You post (or else)", desc: "Get your final video and post it within 30 days. Ghost us? We donate part of your prepayment to charity. You're welcome.", tag: null },
          ].map((s, i, arr) => (
